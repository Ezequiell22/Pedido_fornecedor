  ...
  FQuery
    ...
    .sqlClear
      .sqlAdd('insert into PEDCOMPRA_ITEM (' +
              ...
              'QTDE_PEDIDA, QTDE_RECEBIDA, DESCRICAO, PRECO_UNITARIO, PERC_DESCTO, ' +
              'VALOR_DESCTO, PERC_FINANC, VALOR_TOTAL, DT_INCLUSAO, DT_SOLICITADA, DT_RECEBIDA)')
      .sqlAdd('values (:COD_PEDIDOCOMPRA, :COD_EMPRESA, ' +
              ...
              ':COD_Item, :COD_unidadecompra, :QTDE_PEDIDA, :QTDE_RECEBIDA, :DESCRICAO, :PRECO_UNITARIO, :PERC_DESCTO, ' +
              ':VALOR_DESCTO, :PERC_FINANC, :VALOR_TOTAL, :DT_INCLUSAO, :DT_SOLICITADA, :DT_RECEBIDA)')
      .addParam('COD_PEDIDOCOMPRA', FEntity.COD_PEDIDOCOMPRA)
      ...
      .addParam('QTDE_PEDIDA', FEntity.QTDE_PEDIDA)
      .addParam('QTDE_RECEBIDA', FEntity.QTDE_RECEBIDA)
  ...
  FQuery
    ...
    .sqlClear
      .sqlAdd('update PEDCOMPRA_ITEM set ' +
              ...
              'PERC_FINANC = :PERC_FINANC, VALOR_TOTAL = :VALOR_TOTAL, DT_INCLUSAO = :DT_INCLUSAO, ' +
